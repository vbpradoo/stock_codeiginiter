...
<!--          --><?php //endif; ?>
            ...
            <li class="treeview" id="mainEntryNav">
              <a href="#">
              ...
              <ul class="treeview-menu">
                  <li id="addEntry"><a href="<?php echo base_url('entradas/create') ?>"><i class="fa fa-circle-o"></i> Añadir Entrada</a></li>
                <li id="manageProductNav"><a href="<?php echo base_url('entradas/index') ?>"><i class="fa fa-circle-o"></i>Historial de Entradas</a></li>
              </ul>
            </li>
